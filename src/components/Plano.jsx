...
export default function Plano({ acoes, notificacoes = [], cronogramaEventos = [], userId, isAdmin, meNome, onNova, onEditar, onExcluir, onMarcarNotificacoes }) {
  ...
  return (
    <div className="space-y-4">
      <div className="fixed left-4 top-[118px] z-40 w-[min(19rem,calc(100vw-2rem))] space-y-3">
        {mostrarNotificacoes && (
        ...
        <div className="w-[min(15rem,calc(100vw-2rem))] rounded-2xl border border-slate-200 bg-white/95 p-3 shadow-lg shadow-slate-200/50 backdrop-blur-sm">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" style={{ paddingLeft: mostrarCronograma ? '19rem' : '0', transition: 'padding-left 0.2s ease' }}>
      ...
      <div className="overflow-hidden rounded-lg border border-slate-200 bg-white" style={{ maxWidth: 'calc(100vw - 21rem)' }}>
